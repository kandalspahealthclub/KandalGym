                        ...
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 4px; flex: 1; min-width:0;">
                                ...
                                <div style="display:flex; align-items:center; gap:6px; flex-wrap:nowrap; width:100%;">
                                    <input type="text" value="${c.tel}" onchange="app.updateQRClientField('${c.id}', 'tel', this.value)" class="qr-input-sleek" style="color:var(--text-muted); font-size:0.75rem; padding:0.3rem 0.6rem !important; flex:1; min-width:0; text-overflow:ellipsis; box-sizing: border-box;" placeholder="Telemóvel...">
